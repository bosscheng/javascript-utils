 ...
 * */
var chgCase = function (sStr, iCase) {
 ...
 * todo: 待测试
 * */
var isMouseOut = function (e, handler) {
    if (e.type !== 'mouseout') {
        return false;
    }
 ...
 * 金额大写转换函数
 * */
var transform = function (tranvalue) {
    try {
        var i = 1;
...
var openWindow = function (url, windowName, width, height) {
    var x = parseInt(window.screen.width / 2.0) - (width / 2.0);
    var y = parseInt(window.screen.height / 2.0) - (height / 2.0);
    var retval;
